...
int main()
{
	...
	writer.open("appsrc !  video/x-raw,  width=640, height=480 ! videoconvert ! x264enc tune=zerolatency ! rtph264pay ! gdppay ! tcpserversink host=113.198.244.122 port=5000", 0, (double)30, cv::Size(640, 480), false);
    if (!writer.isOpened()) {
